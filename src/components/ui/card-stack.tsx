      ...
      {cards.map((card, index) => {
        return (
          <motion.div
            onClick={skip}
            key={card.id}
            className="absolute card-background-dark h-60 w-60 md:h-60 md:w-96 rounded-3xl p-4 shadow-xl border border-neutral-200 dark:border-white/[0.1]  shadow-black/[0.1] dark:shadow-white/[0.05] flex flex-col justify-between"
            style={{
